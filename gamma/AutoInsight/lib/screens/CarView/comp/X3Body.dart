...
class X3Body extends StatelessWidget {
  const X3Body({super.key});
                    ...
                    return Builder(
                      builder: (BuildContext context) {
                        return Container(
                          ...
                          child: Image.asset("assets/x3_series$i.png"),
                        );
                      },
                    );
                  }).toList(),
                    ...
                    return Builder(
                      builder: (BuildContext context) {
                        return Container(
                          ...
                          child: Image.asset("assets/x3_colours$i.png"),
                        );
                      },
                    );
                  }).toList(),
                ...
                child: const Column(
                  children: [
                    Row(
                      children: [
                        Expanded(
                          child: Text('Engine: 1995cc-2998cc',
                            style: TextStyle(
                                fontSize: 15,
