...
class ViewCarBody extends StatelessWidget {
  const ViewCarBody({super.key});
            ...
            children: [
              ...
              GridView.count(
                ...
                children: [
                  ...
                  onTap: (){
                    Navigator.push(
                    context,MaterialPageRoute(builder: (context)=> ThreeSeries() )); },
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(
                          context,MaterialPageRoute(builder: (context)=> X3() )); },
                    child: Container(height: 100,width: 100,
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                  ...
                  InkWell(
                     onTap: (){
                       Navigator.push(
                           context,MaterialPageRoute(builder: (context)=> X6())); },
                    child: Container(height: 100,width: 100,
                      decoration: const BoxDecoration(
                          image: DecorationImage(
