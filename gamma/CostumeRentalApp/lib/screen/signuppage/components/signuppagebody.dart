...
class LoginDupBody extends StatefulWidget {
  LoginDupBody({Key? key}) : super(key: key);

  @override
  State<LoginDupBody> createState() => _LoginDupBodyState();
}

class _LoginDupBodyState extends State<LoginDupBody> {
