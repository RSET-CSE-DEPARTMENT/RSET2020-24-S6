...
import 'package:MediTime/pages/new_entry/new_entry_page.dart';
import 'package:provider/provider.dart';
import 'package:sizer/sizer.dart';

import 'new_entry/CameraPage.dart';
//import 'package:alarm/alarm.dart';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              IconButton(
                  icon:const Icon(Icons.camera, color:kPrimaryColor, size:75),
                  alignment: Alignment.bottomLeft,
                  padding: EdgeInsets.only(left: 0.5.w,
                right: 200.w,bottom: 10.w,),
                  onPressed: () async {
                    await Alarm.stop(i);
