...
# Open and read the '2018.csv' file
with open('2018.csv', 'r') as file:
    ...
    for row in reader:
        ...
        if co1 != 0: 
            # If a matching row exists, update the 'y1', 'y2', 'y3', 'y4', 'y5', and 'co2' columns
            sql = "UPDATE college SET y1=?,y2=?,y3=?,y4=?,y5=?,co2=? WHERE ccode=? AND coname=?"
            ...
            insert_query = "INSERT INTO college (sno, ccode, cname, loc, coname, co2, y1, y2, y3, y4, y5) VALUES (?,?,?,?,?,?,?,?,?,?,?)"
