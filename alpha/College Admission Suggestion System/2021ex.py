...
with open('2019.csv', 'r') as file:
    ...
    for row in reader:
        ...
        if co1 != 0: 
            # If a matching row exists, update the 'y1', 'y2', 'y3', 'y4', 'y5', and 'co4' columns
            sql = "UPDATE college SET y1=?,y2=?,y3=?,y4=?,y5=?,co4=? WHERE ccode=? AND coname=?"
            ...
            insert_query = "INSERT INTO college (sno, ccode, cname, loc, coname, co4, y1, y2, y3, y4, y5) VALUES (?,?,?,?,?,?,?,?,?,?,?)"
