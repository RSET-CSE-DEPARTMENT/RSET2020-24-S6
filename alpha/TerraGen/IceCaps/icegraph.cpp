...
class FicegraphInstance : public TVoxelGraphGeneratorInstanceHelper<FicegraphInstance, Uicegraph>
{
public:
	struct FParams
	{
	...
	public:
		...
		struct FBufferConstant
		{
			...
			v_flt Variable_4; // Multiplier = 100.0 output 0
	...
	private:
		...
		FVoxelFastNoise _2D_Cellular_Noise_0_Noise;
		...
		{
			// Init of 2D Cellular Noise
			_2D_Cellular_Noise_0_Noise.SetSeed(FVoxelGraphSeed(1337));
			_2D_Cellular_Noise_0_Noise.SetInterpolation(EVoxelNoiseInterpolation::Quintic);
			_2D_Cellular_Noise_0_Noise.SetCellularJitter(0.45);
			_2D_Cellular_Noise_0_Noise.SetCellularDistanceFunction(EVoxelCellularDistanceFunction::Euclidean);
			_2D_Cellular_Noise_0_Noise.SetCellularReturnType(EVoxelCellularReturnType::CellValue);
		...
		void Function0_XYWithCache_Compute(const FVoxelContext& Context, FBufferX& BufferX, FBufferXY& BufferXY) const
		{
			...
			// 2D Cellular Noise
			v_flt Variable_7; // 2D Cellular Noise output 0
			Variable_7 = _2D_Cellular_Noise_0_Noise.GetCellular_2D(BufferX.Variable_0, Variable_1, BufferConstant.Variable_3);
			Variable_7 = FMath::Clamp<v_flt>(Variable_7, -1.189301, 1.197030);
			
			// *
			BufferXY.Variable_6 = Variable_7 * BufferConstant.Variable_4;
		...
		void Function0_XYZWithCache_Compute(const FVoxelContext& Context, const FBufferX& BufferX, const FBufferXY& BufferXY, FOutputs& Outputs) const
		{
			...
			Variable_5 = Variable_2 - BufferXY.Variable_6;
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContext& Context, FOutputs& Outputs) const
		{
			...
			// 2D Cellular Noise
			v_flt Variable_7; // 2D Cellular Noise output 0
			Variable_7 = _2D_Cellular_Noise_0_Noise.GetCellular_2D(Variable_0, Variable_1, BufferConstant.Variable_3);
			Variable_7 = FMath::Clamp<v_flt>(Variable_7, -1.189301, 1.197030);
			
			// *
			v_flt Variable_6; // * output 0
			Variable_6 = Variable_7 * BufferConstant.Variable_4;
			
			// -
			v_flt Variable_5; // - output 0
			Variable_5 = Variable_2 - Variable_6;
		...
		void Init(const FVoxelGeneratorInit& InitStruct)
		{
			...
			////////////////////////////////////////////////////
			{
				...
				////////////////////////////////////////////////////
				{
					...
					// Init of 2D Cellular Noise
					_2D_Cellular_Noise_1_Noise.SetSeed(FVoxelGraphSeed(1337));
					_2D_Cellular_Noise_1_Noise.SetInterpolation(EVoxelNoiseInterpolation::Quintic);
					_2D_Cellular_Noise_1_Noise.SetCellularJitter(0.45);
					_2D_Cellular_Noise_1_Noise.SetCellularDistanceFunction(EVoxelCellularDistanceFunction::Euclidean);
					_2D_Cellular_Noise_1_Noise.SetCellularReturnType(EVoxelCellularReturnType::CellValue);
			...
			{
				// 2D Cellular Noise
				TVoxelRange<v_flt> Variable_4; // 2D Cellular Noise output 0
				Variable_4 = { -1.189301f, 1.197030f };
				
				// Multiplier = 100.0
				TVoxelRange<v_flt> Variable_1; // Multiplier = 100.0 output 0
				Variable_1 = Params.Multiplier;
				
				// *
				BufferConstant.Variable_3 = Variable_4 * Variable_1;
	...
	private:
		...
		FVoxelFastNoise _2D_Cellular_Noise_1_Noise;
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContextRange& Context, FOutputs& Outputs) const
		{
			...
			Variable_2 = Variable_0 - BufferConstant.Variable_3;
			
			Outputs.Value = Variable_2;
		}
		
	};
	
	FicegraphInstance(Uicegraph& Object)
...
template<>
inline v_flt FicegraphInstance::FLocalComputeStruct_LocalValue::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FicegraphInstance::FLocalComputeStruct_LocalValue::FOutputs::Set<v_flt, 1>(v_flt InValue)
{
	Value = InValue;
}
template<>
inline FVoxelMaterial FicegraphInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Get<FVoxelMaterial, 2>() const
{
	return MaterialBuilder.Build();
}
template<>
inline void FicegraphInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Set<FVoxelMaterial, 2>(FVoxelMaterial Material)
{
}
template<>
inline v_flt FicegraphInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 3>() const
{
	return UpVectorX;
}
template<>
inline void FicegraphInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 3>(v_flt InValue)
{
	UpVectorX = InValue;
}
template<>
inline v_flt FicegraphInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 4>() const
{
	return UpVectorY;
}
template<>
inline void FicegraphInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 4>(v_flt InValue)
{
	UpVectorY = InValue;
}
template<>
inline v_flt FicegraphInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 5>() const
{
	return UpVectorZ;
}
template<>
inline void FicegraphInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 5>(v_flt InValue)
{
	UpVectorZ = InValue;
}
template<>
inline TVoxelRange<v_flt> FicegraphInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FicegraphInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Set<v_flt, 1>(TVoxelRange<v_flt> InValue)
{
	Value = InValue;
}
template<>
inline auto& FicegraphInstance::GetTarget<1>() const
{
	return LocalValue;
}
template<>
inline auto& FicegraphInstance::GetTarget<2>() const
{
	return LocalMaterial;
}
template<>
inline auto& FicegraphInstance::GetRangeTarget<0, 1>() const
{
	return LocalValueRangeAnalysis;
}
template<>
inline auto& FicegraphInstance::GetTarget<3, 4, 5>() const
{
...
TVoxelSharedRef<FVoxelTransformableGeneratorInstance> Uicegraph::GetTransformableInstance()
{
#if VOXEL_GRAPH_GENERATED_VERSION == 1
	return MakeVoxelShared<FicegraphInstance>(*this);
#else
#if VOXEL_GRAPH_GENERATED_VERSION > 1
	EMIT_CUSTOM_WARNING("Outdated generated voxel graph: icegraph. You need to regenerate it.");
	FVoxelMessages::Warning("Outdated generated voxel graph: icegraph. You need to regenerate it.");
#else
	EMIT_CUSTOM_WARNING("Generated voxel graph is more recent than the Voxel Plugin version: icegraph. You need to update the plugin.");
	FVoxelMessages::Warning("Generated voxel graph is more recent than the Voxel Plugin version: icegraph. You need to update the plugin.");
#endif
